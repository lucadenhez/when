      ...
      <div className="text-center space-y-10">
        ...
        >
          <div className="flex justify-center">
            <h1 className="text-4xl font-semibold md:max-w-[70%] max-w-[80%]">
              Import your favorite calendar to join this event
            </h1>
          </div>
        </motion.div>
        <div className="space-y-3 max-w-[90%] m-auto">
          {calendar_upload_choices.map((calendar_choice) => (
            <CalendarUpload key={calendar_choice.Title} {...calendar_choice} />
          ))}
        </div>
      </div>
    </div>
